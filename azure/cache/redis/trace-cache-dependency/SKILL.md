...
description: "Trace Cache Dependency across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Redis instances, tiers, regions, networking, consumers, keyspace metadata, TTL policy, capacity, latency, and availability."
---

# Trace Cache Dependency
...
4. Execute **Trace Cache Dependency**. Follow resource relationships and timestamps; distinguish observed facts from inference.
