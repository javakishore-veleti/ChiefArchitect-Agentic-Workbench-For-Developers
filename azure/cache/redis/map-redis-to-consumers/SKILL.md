...
description: "Map Redis To Consumers across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Redis instances, tiers, regions, networking, consumers, keyspace metadata, TTL policy, capacity, latency, and availability."
---

# Map Redis To Consumers
...
4. Execute **Map Redis To Consumers**. Follow resource relationships and timestamps; distinguish observed facts from inference.
