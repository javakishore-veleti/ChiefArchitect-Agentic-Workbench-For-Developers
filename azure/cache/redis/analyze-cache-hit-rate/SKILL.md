...
description: "Analyze Cache Hit Rate across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Redis instances, tiers, regions, networking, consumers, keyspace metadata, TTL policy, capacity, latency, and availability."
---
...
4. Execute **Analyze Cache Hit Rate**. Follow resource relationships and timestamps; distinguish observed facts from inference.
