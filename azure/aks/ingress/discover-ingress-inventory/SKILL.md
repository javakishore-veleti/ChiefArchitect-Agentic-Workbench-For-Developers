...
description: "Discover Ingress Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about ingress controllers, ingress resources, gateway routes, hosts, paths, services, certificates, namespaces, and owners."
---

# Discover Ingress Inventory
...
4. Execute **Discover Ingress Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
