...
description: "Map Hosts To Services across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about ingress controllers, ingress resources, gateway routes, hosts, paths, services, certificates, namespaces, and owners."
---

# Map Hosts To Services
...
4. Execute **Map Hosts To Services**. Follow resource relationships and timestamps; distinguish observed facts from inference.
