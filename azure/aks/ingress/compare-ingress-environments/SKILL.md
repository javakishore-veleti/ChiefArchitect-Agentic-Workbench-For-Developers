...
description: "Compare Ingress Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about ingress controllers, ingress resources, gateway routes, hosts, paths, services, certificates, namespaces, and owners."
---

# Compare Ingress Environments
...
2. Discover ingress controllers, ingress resources, gateway routes, hosts, paths, services, certificates, namespaces, and owners using Kubernetes APIs, ingress-controller configuration and logs, Azure DNS, load-balancer metadata, certificates, and approved service catalogs.
...
4. Execute **Compare Ingress Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
