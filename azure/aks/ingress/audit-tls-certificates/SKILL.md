...
description: "Audit Tls Certificates across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about ingress controllers, ingress resources, gateway routes, hosts, paths, services, certificates, namespaces, and owners."
---
...
4. Execute **Audit Tls Certificates**. Follow resource relationships and timestamps; distinguish observed facts from inference.
