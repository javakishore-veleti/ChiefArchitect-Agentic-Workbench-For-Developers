...
description: "Discover Secret Reference Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about secret references, consuming workloads, CSI mounts, identities, certificate metadata, namespaces, and owners."
---
...
4. Execute **Discover Secret Reference Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
