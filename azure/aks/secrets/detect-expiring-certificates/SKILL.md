...
description: "Detect Expiring Certificates across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about secret references, consuming workloads, CSI mounts, identities, certificate metadata, namespaces, and owners."
---
...
4. Execute **Detect Expiring Certificates**. Follow resource relationships and timestamps; distinguish observed facts from inference.
