...
description: "Audit Secret Handling across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about secret references, consuming workloads, CSI mounts, identities, certificate metadata, namespaces, and owners."
---
...
4. Execute **Audit Secret Handling**. Follow resource relationships and timestamps; distinguish observed facts from inference.
