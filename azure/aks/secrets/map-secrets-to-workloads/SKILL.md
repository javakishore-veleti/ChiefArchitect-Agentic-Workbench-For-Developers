...
description: "Map Secrets To Workloads across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about secret references, consuming workloads, CSI mounts, identities, certificate metadata, namespaces, and owners."
---

# Map Secrets To Workloads
...
2. Discover secret references, consuming workloads, CSI mounts, identities, certificate metadata, namespaces, and owners using Kubernetes metadata, workload specifications, CSI driver state, Key Vault references, certificate metadata, and approved audit records.
...
4. Execute **Map Secrets To Workloads**. Follow resource relationships and timestamps; distinguish observed facts from inference.
