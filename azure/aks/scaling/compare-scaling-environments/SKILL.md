...
description: "Compare Scaling Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about pod and node scaling policies, metrics, thresholds, capacity, events, workloads, namespaces, and environments."
---

# Compare Scaling Environments
...
2. Discover pod and node scaling policies, metrics, thresholds, capacity, events, workloads, namespaces, and environments using Kubernetes metrics and events, HPA and VPA specifications, cluster autoscaler state, Azure Monitor metrics, and workload configuration.
...
4. Execute **Compare Scaling Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
