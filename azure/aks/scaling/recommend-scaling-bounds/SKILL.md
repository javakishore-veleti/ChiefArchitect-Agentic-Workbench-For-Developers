...
description: "Recommend Scaling Bounds across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about pod and node scaling policies, metrics, thresholds, capacity, events, workloads, namespaces, and environments."
---

# Recommend Scaling Bounds
...
4. Execute **Recommend Scaling Bounds**. Follow resource relationships and timestamps; distinguish observed facts from inference.
