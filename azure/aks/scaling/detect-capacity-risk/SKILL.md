...
description: "Detect Capacity Risk across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about pod and node scaling policies, metrics, thresholds, capacity, events, workloads, namespaces, and environments."
---
...
4. Execute **Detect Capacity Risk**. Follow resource relationships and timestamps; distinguish observed facts from inference.
