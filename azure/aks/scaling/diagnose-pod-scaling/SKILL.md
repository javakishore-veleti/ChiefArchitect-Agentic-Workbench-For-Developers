...
description: "Diagnose Pod Scaling across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about pod and node scaling policies, metrics, thresholds, capacity, events, workloads, namespaces, and environments."
---

# Diagnose Pod Scaling
...
4. Execute **Diagnose Pod Scaling**. Follow resource relationships and timestamps; distinguish observed facts from inference.
