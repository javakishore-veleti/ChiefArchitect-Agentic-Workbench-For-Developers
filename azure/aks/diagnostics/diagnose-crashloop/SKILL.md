...
description: "Diagnose Crashloop across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about clusters, nodes, namespaces, workloads, events, logs, traces, metrics, dependencies, and ownership metadata."
---
...
4. Execute **Diagnose Crashloop**. Follow resource relationships and timestamps; distinguish observed facts from inference.
