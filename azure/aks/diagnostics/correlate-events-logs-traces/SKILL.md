...
description: "Correlate Events Logs Traces across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about clusters, nodes, namespaces, workloads, events, logs, traces, metrics, dependencies, and ownership metadata."
---

# Correlate Events Logs Traces
...
2. Discover clusters, nodes, namespaces, workloads, events, logs, traces, metrics, dependencies, and ownership metadata using Kubernetes events and logs, Azure Monitor, Application Insights, container insights, deployment metadata, and approved observability systems.
...
4. Execute **Correlate Events Logs Traces**. Follow resource relationships and timestamps; distinguish observed facts from inference.
