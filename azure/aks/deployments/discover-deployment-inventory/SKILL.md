...
description: "Discover Deployment Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS deployments and their ReplicaSets, pods, images, namespaces, owners, and environment metadata."
---

# Discover Deployment Inventory
...
2. Discover AKS deployments and their ReplicaSets, pods, images, namespaces, owners, and environment metadata using Azure Resource Graph, Azure CLI, Kubernetes APIs, deployment manifests, rollout events, and approved Git repositories.
...
4. Execute **Discover Deployment Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
