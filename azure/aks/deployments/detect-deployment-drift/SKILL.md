...
description: "Detect Deployment Drift across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS deployments and their ReplicaSets, pods, images, namespaces, owners, and environment metadata."
---
...
4. Execute **Detect Deployment Drift**. Follow resource relationships and timestamps; distinguish observed facts from inference.
