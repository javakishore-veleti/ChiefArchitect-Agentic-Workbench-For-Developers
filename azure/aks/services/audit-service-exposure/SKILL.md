...
description: "Audit Service Exposure across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata."
---
...
4. Execute **Audit Service Exposure**. Follow resource relationships and timestamps; distinguish observed facts from inference.
