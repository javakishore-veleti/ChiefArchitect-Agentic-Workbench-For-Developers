...
description: "Diagnose Endpoint Failure across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata."
---

# Diagnose Endpoint Failure
...
4. Execute **Diagnose Endpoint Failure**. Follow resource relationships and timestamps; distinguish observed facts from inference.
