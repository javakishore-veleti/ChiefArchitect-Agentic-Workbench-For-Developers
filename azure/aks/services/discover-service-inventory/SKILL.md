...
description: "Discover Service Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata."
---

# Discover Service Inventory
...
4. Execute **Discover Service Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
