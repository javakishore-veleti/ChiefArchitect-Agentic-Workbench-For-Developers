...
description: "Compare Service Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata."
---

# Compare Service Environments
...
2. Discover AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata using Kubernetes APIs, Azure Resource Graph, Azure CLI, endpoint slices, network configuration, and approved service catalogs.
...
4. Execute **Compare Service Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
