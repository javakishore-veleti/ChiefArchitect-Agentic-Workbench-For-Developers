...
description: "Validate Selector Mapping across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about AKS Services, endpoints, selectors, workloads, ports, exposure types, namespaces, and ownership metadata."
---
...
4. Execute **Validate Selector Mapping**. Follow resource relationships and timestamps; distinguish observed facts from inference.
