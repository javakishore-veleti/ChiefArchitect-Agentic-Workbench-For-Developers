...
description: "Validate Configuration References across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about runtime configuration, ConfigMaps, references, consuming workloads, namespaces, owners, and environment differences."
---
...
4. Execute **Validate Configuration References**. Follow resource relationships and timestamps; distinguish observed facts from inference.
