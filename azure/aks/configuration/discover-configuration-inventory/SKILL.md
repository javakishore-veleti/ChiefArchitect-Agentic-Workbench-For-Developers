...
description: "Discover Configuration Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about runtime configuration, ConfigMaps, references, consuming workloads, namespaces, owners, and environment differences."
---

# Discover Configuration Inventory
...
2. Discover runtime configuration, ConfigMaps, references, consuming workloads, namespaces, owners, and environment differences using Kubernetes APIs, ConfigMaps, workload specifications, deployment manifests, Azure App Configuration metadata, and approved Git repositories.
...
4. Execute **Discover Configuration Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
