...
description: "Diagnose Missing Configuration across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about runtime configuration, ConfigMaps, references, consuming workloads, namespaces, owners, and environment differences."
---
...
4. Execute **Diagnose Missing Configuration**. Follow resource relationships and timestamps; distinguish observed facts from inference.
