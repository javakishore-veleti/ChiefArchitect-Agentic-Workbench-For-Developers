...
description: "Discover Application Insights Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about components, applications, services, operations, traces, dependencies, exceptions, availability tests, alerts, environments, and owners."
---

# Discover Application Insights Inventory
...
2. Discover components, applications, services, operations, traces, dependencies, exceptions, availability tests, alerts, environments, and owners using Application Insights, Azure Monitor, Log Analytics, deployment metadata, distributed traces, dependency maps, metrics, logs, and approved service catalogs.
...
4. Execute **Discover Application Insights Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
