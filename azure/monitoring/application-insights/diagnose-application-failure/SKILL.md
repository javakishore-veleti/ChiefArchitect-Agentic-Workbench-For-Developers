...
description: "Diagnose Application Failure across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about components, applications, services, operations, traces, dependencies, exceptions, availability tests, alerts, environments, and owners."
---
...
4. Execute **Diagnose Application Failure**. Follow resource relationships and timestamps; distinguish observed facts from inference.
