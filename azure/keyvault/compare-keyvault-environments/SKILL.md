...
description: "Compare Keyvault Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Key Vaults, keys, secret and certificate metadata, access models, identities, expiration dates, private endpoints, and consumers."
---

# Compare Keyvault Environments
...
2. Discover Key Vaults, keys, secret and certificate metadata, access models, identities, expiration dates, private endpoints, and consumers using Azure Resource Graph, Azure CLI, Key Vault metadata, RBAC assignments, diagnostic logs, workload references, and approved configuration repositories.
...
4. Execute **Compare Keyvault Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
