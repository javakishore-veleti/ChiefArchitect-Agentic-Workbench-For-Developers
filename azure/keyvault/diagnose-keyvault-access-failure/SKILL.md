...
description: "Diagnose Keyvault Access Failure across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Key Vaults, keys, secret and certificate metadata, access models, identities, expiration dates, private endpoints, and consumers."
---
...
4. Execute **Diagnose Keyvault Access Failure**. Follow resource relationships and timestamps; distinguish observed facts from inference.
