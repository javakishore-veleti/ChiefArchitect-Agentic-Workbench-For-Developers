...
description: "Discover Keyvault Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Key Vaults, keys, secret and certificate metadata, access models, identities, expiration dates, private endpoints, and consumers."
---

# Discover Keyvault Inventory
...
4. Execute **Discover Keyvault Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
