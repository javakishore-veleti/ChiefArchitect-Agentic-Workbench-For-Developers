...
description: "Map Vault Items To Consumers across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about Key Vaults, keys, secret and certificate metadata, access models, identities, expiration dates, private endpoints, and consumers."
---
...
4. Execute **Map Vault Items To Consumers**. Follow resource relationships and timestamps; distinguish observed facts from inference.
