...
description: "Map Identities To Workloads across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about applications, service principals, managed identities, role assignments, API permissions, credentials metadata, sign-ins, and workload mappings."
---
...
4. Execute **Map Identities To Workloads**. Follow resource relationships and timestamps; distinguish observed facts from inference.
