...
description: "Discover Entra Application Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about applications, service principals, managed identities, role assignments, API permissions, credentials metadata, sign-ins, and workload mappings."
---

# Discover Entra Application Inventory
...
2. Discover applications, service principals, managed identities, role assignments, API permissions, credentials metadata, sign-ins, and workload mappings using Microsoft Graph, Azure Resource Graph, Azure CLI, app-registration metadata, enterprise applications, RBAC assignments, sign-in logs, and workload configuration.
...
4. Execute **Discover Entra Application Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
