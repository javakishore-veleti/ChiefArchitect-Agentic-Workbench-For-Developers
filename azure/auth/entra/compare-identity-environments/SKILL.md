...
description: "Compare Identity Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about applications, service principals, managed identities, role assignments, API permissions, credentials metadata, sign-ins, and workload mappings."
---

# Compare Identity Environments
...
4. Execute **Compare Identity Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
