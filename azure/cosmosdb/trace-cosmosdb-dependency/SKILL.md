...
description: "Trace Cosmosdb Dependency across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about accounts, databases, containers, regions, partition keys, throughput, indexes, consumers, latency, and throttling."
---

# Trace Cosmosdb Dependency
...
4. Execute **Trace Cosmosdb Dependency**. Follow resource relationships and timestamps; distinguish observed facts from inference.
