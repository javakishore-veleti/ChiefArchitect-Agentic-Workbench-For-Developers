...
description: "Audit Data Access across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about accounts, databases, containers, regions, partition keys, throughput, indexes, consumers, latency, and throttling."
---
...
4. Execute **Audit Data Access**. Follow resource relationships and timestamps; distinguish observed facts from inference.
