...
description: "Compare Cosmosdb Environments across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about accounts, databases, containers, regions, partition keys, throughput, indexes, consumers, latency, and throttling."
---

# Compare Cosmosdb Environments
...
2. Discover accounts, databases, containers, regions, partition keys, throughput, indexes, consumers, latency, and throttling using Azure Resource Graph, Azure CLI, Cosmos DB metadata, Azure Monitor metrics, diagnostic logs, indexing policies, and approved application configuration.
...
4. Execute **Compare Cosmosdb Environments**. Follow resource relationships and timestamps; distinguish observed facts from inference.
