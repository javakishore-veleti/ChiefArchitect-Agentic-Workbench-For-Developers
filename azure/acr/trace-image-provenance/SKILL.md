...
description: "Trace Image Provenance across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about registries, repositories, image tags and digests, scan status, retention policies, identities, deployments, and owners."
---
...
4. Execute **Trace Image Provenance**. Follow resource relationships and timestamps; distinguish observed facts from inference.
