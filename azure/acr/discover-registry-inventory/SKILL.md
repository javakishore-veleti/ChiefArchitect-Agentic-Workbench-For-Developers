...
description: "Discover Registry Inventory across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about registries, repositories, image tags and digests, scan status, retention policies, identities, deployments, and owners."
---

# Discover Registry Inventory
...
2. Discover registries, repositories, image tags and digests, scan status, retention policies, identities, deployments, and owners using Azure Resource Graph, Azure CLI, ACR metadata, image manifests, vulnerability results, AKS workload specifications, and pipeline records.
...
4. Execute **Discover Registry Inventory**. Follow resource relationships and timestamps; distinguish observed facts from inference.
