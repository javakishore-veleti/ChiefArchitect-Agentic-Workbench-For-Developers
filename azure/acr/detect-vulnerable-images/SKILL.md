...
description: "Detect Vulnerable Images across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about registries, repositories, image tags and digests, scan status, retention policies, identities, deployments, and owners."
---
...
4. Execute **Detect Vulnerable Images**. Follow resource relationships and timestamps; distinguish observed facts from inference.
