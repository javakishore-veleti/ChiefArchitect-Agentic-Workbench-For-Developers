...
description: "Audit Registry Access across authorized AKIV Diagnostics Azure environments. Use when developers or operators need evidence about registries, repositories, image tags and digests, scan status, retention policies, identities, deployments, and owners."
---
...
4. Execute **Audit Registry Access**. Follow resource relationships and timestamps; distinguish observed facts from inference.
